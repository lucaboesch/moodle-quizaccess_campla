...
class submitticketform extends \core_form\dynamic_form {
    ...
    public function set_data_for_dynamic_submission(): void {
        ...
        $quizname = \quizaccess_campla\settings_provider::get_campla_quizname(27);
        $coursename = \quizaccess_campla\settings_provider::get_campla_coursename(27);
        $quizurl = new \moodle_url('/mod/quiz/view.php', ['id' => 27]);
        if (\quizaccess_campla\settings_provider::get_campla_timeopen(27) !== 0) {
            $quizopens = \core_date::strftime(get_string('strftimerecentfull', 'langconfig'),
                \quizaccess_campla\settings_provider::get_campla_timeopen(27));
        } else {
            $quizopens = get_string('na', 'quizaccess_campla');
        }
        if (\quizaccess_campla\settings_provider::get_campla_timeclose(27) !== 0) {
            $quizcloses = \core_date::strftime(get_string('strftimerecentfull', 'langconfig'),
                \quizaccess_campla\settings_provider::get_campla_timeclose(27));
        } else {
